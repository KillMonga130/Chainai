...
export function FeatureCard({ icon: Icon, title, description, index = 0 }: FeatureCardProps) {
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl bg-slate-800/50 dark:bg-slate-800/50 light:bg-white/80 backdrop-blur-sm border border-slate-700/50 dark:border-slate-700/50 light:border-slate-200 hover:border-indigo-500/50 transition-all duration-300 p-8"
    >
